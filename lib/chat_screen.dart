          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                List<Widget> messageWidgets = messages.where((msg) {
                  return (msg['sender'] == user?.uid && msg['receiver'] == widget.receiverId) ||
                         (msg['sender'] == widget.receiverId && msg['receiver'] == user?.uid);
                }).map((msg) {
